...
- (void)makeMyProgressBarMoving {
    ...
    if (actual < 1) {
        threadProgressView.progress = actual + .01;
       myTimer =  [NSTimer scheduledTimerWithTimeInterval:0.06 target:self selector:@selector(makeMyProgressBarMoving) userInfo:nil repeats:NO];
